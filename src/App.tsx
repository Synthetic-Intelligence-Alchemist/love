...
// FIX: Import SpeechRecognition type as ISpeechRecognition to avoid naming conflict with the constructor variable.
import { VideoSource, Status, Message, Language, SpeechRecognition as ISpeechRecognition } from './types';
...
const App: React.FC = () => {
    ...
    // FIX: Use the imported ISpeechRecognition type for the ref.
